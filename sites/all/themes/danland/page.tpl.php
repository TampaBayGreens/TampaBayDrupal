...
// JPJ Bypass main page
    if (isset($_GET["format"])?$_GET["format"] == "simple":false) {
        include ('/home/content/93/7192693/html/tampabay/sites/all/libraries/tampabay/page-node-simple.tpl.php');
        return;
    }
?>
...
<div class="slideshow">
<img src="<?php print $base_path . $directory; ?>/images/slideshows/grow_kleiner_banner.jpg" width="950" height="355" alt="slideshow 1"/>
<img src="<?php print $base_path . $directory; ?>/images/slideshows/RomnyMa_banner.jpg" width="950" height="355" alt="slideshow 2"/>
</div>
</div>
</div>
<?php endif; ?>
